...
public class FileUtil {
	...
	public static final String AUTORESOLUTION = SDCARD + "/AutoResolution/";
	public static final String SRC_XML = SDCARD + "/AutoResolution/src.xml";
	public static final String APP = "AutoResolution";
	 ...
	 * @return
	 */
	public static boolean delFileFromDirectory(String path,
			List<String> exceptFileList) {
		boolean find = false;
		String filename = "";
		File directory = new File(path);
		if (directory.exists() && directory.isDirectory()) {
	 ...
	 * @return
	 */
	public static boolean delFileFromDirectoryEx(String path,
			List<String> exceptFileList) {
		boolean find = false;
		String filename = "";
		File directory = new File(path);
		...
		try {
			...
			if (bCreate) {
				...
				while (nCounter < nLength) {
					nWrite = (nLength - nCounter) > 1024 ? 1024 : nLength
							- nCounter;
